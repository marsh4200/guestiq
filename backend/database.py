...
MIGRATIONS = [
    ...
    # --- offline license activation (see backend/licensing.py) ---
    # server_id is generated once on first boot and never changes;
    # license_key is what gets pasted in on the activation screen.
    "ALTER TABLE settings ADD COLUMN server_id TEXT DEFAULT ''",
    "ALTER TABLE settings ADD COLUMN license_key TEXT DEFAULT ''",
]
